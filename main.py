...
def build_dashboard_payload():
    ...
    live_market, calendar, earnings, news, live_movers = get_live_market_data(), get_live_calendar(), get_live_earnings(), get_live_news(), get_live_movers()
    live_strip = [
    ...
    return {'status': 'online', 'risk': risk, 'driver': driver, 'morning_edge': morning, 'session_significance': significance, 'market_movers_engine': movers, 'alerts': alerts, 'assistant': assistant, 'settings': settings, 'major_indexes': live_market['major_indexes'], 'watchlist': live_market['watchlist'], 'live_movers': live_movers, 'calendar': calendar, 'earnings': earnings, 'news': news, 'live_strip': live_strip, 'forex_factory_notes_url': FOREX_FACTORY_NOTES_URL}
