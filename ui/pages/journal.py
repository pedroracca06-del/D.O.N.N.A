  ...
  <div class="page" id="page-journal">
    <div class="vstack">
      ...
      <section class="jn-work-view" id="jWorkView-goals" data-jview-panel="goals">
        ...
        <div class="jn-goals-grid"><form class="jn-entry-form" id="jGoalForm"><div class="jn-form-grid"><label>Period<select id="jGoalPeriod"><option>DAILY</option><option>WEEKLY</option><option>MONTHLY</option><option>QUARTERLY</option><option>ANNUAL</option></select></label><label>Target date<input id="jGoalDate" type="date"></label></div><label>Goal<input id="jGoalTitle" placeholder="Follow every risk rule" required></label><label>Checklist items<textarea id="jGoalChecklist" placeholder="One item per line"></textarea></label><button class="jn-action" type="submit">Add Goal</button><div class="jn-form-status" id="jGoalStatus" aria-live="polite"></div></form><section class="jn-system-card"><div class="jn-sec-head"><h2>NOVA Trading System</h2><button class="jn-system-edit-btn" id="jSystemEditBtn" type="button" onclick="editJournalSystem()">Edit rules</button></div><div id="jSystemSummary"></div><div class="jn-form-status" id="jSystemStatus" aria-live="polite"></div></section></div><div class="jn-record-list" id="jGoalList"></div>
      </section>
